                        ...
                        <Form {...form}>
                            ...
                            <form className="mt-8 grid grid-cols-6 gap-6" onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    <Button type="submit" className="inline-block shrink-0 rounded-md border px-12 py-3 text-sm font-medium text-white">
                                        Register
                                    </Button>

                                    <span className="mt-4 text-sm sm:mt-0">already have account?</span>
